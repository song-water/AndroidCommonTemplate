...
import com.water.song.template.common.util.dp2px
...
class TIndicator @JvmOverloads constructor(
    ...
    private var selectedDotRadiusPx = DEFAULT_SELECTED_DOT_RADIUS_DP.dp2px(context)
    private var dotRadiusPx = DEFAULT_DOT_RADIUS_DP.dp2px(context)
    private var dotSeparationDistancePx =
        DEFAULT_DOT_SEPARATION_DISTANCE_DP.dp2px(context)
