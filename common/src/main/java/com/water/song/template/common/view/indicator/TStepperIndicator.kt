...
package com.water.song.template.common.view.indicator
...
//        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TStepperIndicator, defStyleAttr, 0);
        ...
        circlePaint = Paint().apply {
            ...
            color = a.getColor(R.styleable.TStepperIndicator_stpi_circleColor, defaultCircleColor)
            isAntiAlias = true
        }
        ...
        indicatorPaint = Paint(circlePaint).apply {
            ...
            color = a.getColor(R.styleable.TStepperIndicator_stpi_indicatorColor, defaultPrimaryColor)
            isAntiAlias = true
        }

        stepTextNumberPaint = Paint(indicatorPaint).apply {
            textSize = getResources().getDimension(R.dimen.stpi_default_text_size)
        }
        ...
        linePaint = Paint().apply {
            ...
            style = Paint.Style.STROKE
            color = a.getColor(R.styleable.TStepperIndicator_stpi_lineColor, defaultLineColor)
            isAntiAlias = true
        }

        lineDonePaint = Paint(linePaint).apply {
            color = a.getColor(R.styleable.TStepperIndicator_stpi_lineDoneColor, defaultPrimaryColor)
        }
        ...
        if (useBottomIndicator) {
            ...
            if (bottomIndicatorHeight <= 0) {
                Log.i(
                    TAG,
                    "init: Invalid indicator height, disabling bottom indicator feature! Please provide " +
            ...
            bottomIndicatorWidth =
                a.getDimension(R.styleable.TStepperIndicator_stpi_bottomIndicatorWidth, defaultWidth)
        ...
        indicatorRadius =
            a.getDimension(R.styleable.TStepperIndicator_stpi_indicatorRadius, defaultIndicatorRadius)
        ...
        animDuration =
            a.getInteger(R.styleable.TStepperIndicator_stpi_animDuration, DEFAULT_ANIMATION_DURATION)
        ...
        labelPaint = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
        ...
        labelMarginTop =
            a.getDimension(R.styleable.TStepperIndicator_stpi_labelMarginTop, defaultLabelMarginTop)
        ...
        if (isInEditMode) {
            currentStep = max(ceil(stepCount / 2f.toDouble()).toInt(), 1)
        }
    ...
    private val randomPaint: Paint
        get() {
            return Paint(indicatorPaint).apply {
                color = randomColor
            }
        }
    ...
    private fun calculateMaxLabelHeight(measuredWidth: Int) {
        ...
        for (i in labels!!.indices) {
            ...
            maxLabelHeight = max(maxLabelHeight, labelLayouts!![i]!!.lineCount * labelSingleLineHeight)
        }
    }

    private val stepCenterY: Float
        get() = (measuredHeight - getBottomIndicatorHeight() - getMaxLabelHeight()) / 2f
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in indicators!!.indices) {
            ...
            if (showStepTextNumber) {
                ...
                stepAreaRect[(indicator - circleRadius).toInt(), (centerY - circleRadius).toInt(), (indicator + circleRadius).toInt()] =
                ...
                canvas.drawText(
                    stepLabel, stepAreaRectF.left, stepAreaRectF.top - stepTextNumberPaint.ascent(),
                    stepTextNumberPaint
                )
            }
            ...
            if (useBottomIndicator) {
                ...
                if (i == currentStep) {
                    ...
                    canvas.drawRect(
                        indicator - bottomIndicatorWidth / 2, height - bottomIndicatorHeight,
            ...
            if (drawCheck) {
                ...
                if (i == previousStep && drawToNext || i == currentStep && drawFromNext) radius =
                    animCheckRadius
    ...
    private fun getPaint(stepPosition: Int, sourceList: List<Paint>?, defaultPaint: Paint?): Paint {
        ...
        if (null != sourceList && sourceList.isNotEmpty()) {
            try {
    ...
    fun setCurrentStep(currentStep: Int) {
        ...
        if (currentStep == previousStep + 1) {
            ...
            checkAnimator = ObjectAnimator.ofFloat(
                this@TStepperIndicator, "animCheckRadius", indicatorRadius,
            ...
            indicatorAnimator = ObjectAnimator.ofFloat(
                this@TStepperIndicator, "animIndicatorRadius", 0f,
        ...
        if (animatorSet != null) {
            ...
            lineAnimator!!.duration = min(500, animDuration).toLong()
    ...
    val isOnStepClickListenerAvailable: Boolean
        get() = onStepClickListeners.isNotEmpty()
